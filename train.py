...
def parse_opt(known=False):
    ...
    #parser.add_argument('--batch-size', type=int, default=150, help='total batch size for all GPUs')
    ...
    parser.add_argument('--workers', type=int, default=192, help='maximum number of dataloader workers')
    parser.add_argument('--project', default='runs/l_e500', help='save to project/name')
